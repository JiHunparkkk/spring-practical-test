...
//@WebMvcTest(controllers = ProductController.class) //Controller 만 하기 위해서 가볍게 하는 어노테이션?
class ProductControllerTest extends ControllerTestSupport {
    ...
    void createProduct() throws Exception {
        ...
        // when // then
        // post 는 http body 에 담겨서 옴. 따라서 직렬화와 역질렬화가 필요함.
        mockMvc.perform(
    ...
    void createProductWithoutType() throws Exception {
        ...
        //위의 코드 사용할 때는 getter 필요. (ApiResponse)
    }
